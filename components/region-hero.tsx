        ...
        >
          ...
          <div className="region-hero-content d-flex flex-column justify-content-start">
            <div className="region-hero-inner">
              <div className="pt-4 text-white region-hero-text">
              ...
              {rightOverlay && rightOverlayMode === "tachos" && (
                <div className="mt-auto pb-3 d-flex justify-content-center w-100 region-hero-tacho-wrap">
                  <div
              ...
              {rightOverlay && rightOverlayMode === "buttons" && (
                <div className="mt-auto d-flex justify-content-center w-100">
                  <div
                    className="d-flex flex-row gap-2 justify-content-center region-hero-buttons"
                    style={{
                      marginBottom: 0,
                      paddingBottom: 0,
                      maxWidth: "360px",
