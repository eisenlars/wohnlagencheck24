...
export default function PartnerPasswordResetClient() {
  ...
  useEffect(() => {
    let mounted = true;
    const invalidMessage = "Der Passwort-Link ist ungueltig oder abgelaufen. Bitte fordere ueber die Anmeldeseite einen neuen Passwort-Link an.";
    ...
    return (
      <div style={{ maxWidth: 420, margin: "90px auto", fontFamily: "sans-serif" }}>
        <div style={{ display: "grid", gap: 12, border: "1px solid #ddd", padding: 24, borderRadius: 8 }}>
          <h2 style={{ margin: 0, color: "#111827" }}>Passwort neu setzen</h2>
