...
import {
  createContentForNetworkPartner,
  listContentByNetworkPartner,
...
export async function GET() {
  try {
    ...
    const contentItems = await listContentByNetworkPartner(actor.networkPartnerId);
...
export async function POST(req: Request) {
  try {
    ...
    const contentItem = await createContentForNetworkPartner({
