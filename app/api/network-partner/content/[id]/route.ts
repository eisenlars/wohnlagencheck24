...
import {
  getContentByIdForNetworkPartner,
  updateContentForNetworkPartner,
...
export async function GET(
  ...
  try {
    ...
    const contentItem = await getContentByIdForNetworkPartner(contentId, actor.networkPartnerId);
    if (!contentItem) {
...
export async function PATCH(
  ...
  try {
    ...
    const contentItem = await updateContentForNetworkPartner({
      id: contentId,
