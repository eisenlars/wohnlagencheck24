...
import {
  autoPrefillNetworkContentTranslations,
  listNetworkContentTranslationsForPortalPartner,
  upsertNetworkContentTranslation,
...
export async function GET(
  ...
  try {
    ...
    const payload = await listNetworkContentTranslationsForPortalPartner({
      contentItemId: contentId,
      portalPartnerId: actor.partnerId,
    });
...
export async function POST(
  ...
  try {
    ...
    if (mode === "autofill") {
      ...
      await autoPrefillNetworkContentTranslations({
        contentItemId: contentId,
        portalPartnerId: actor.partnerId,
