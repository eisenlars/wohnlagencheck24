    ...
    <div className="text-dark">
      ...
      <div className="container immobilienmarkt-container position-relative">
        ...
        <section className="mb-4" id="grundstueckspreise-allgemein">
          <header className="mb-3">
            {vm.headlineSectionIndividuell ? (
              <>
                <h2 className="h5 text-muted text-uppercase mb-1">{vm.headlineSection}</h2>
          ...
          {vm.ueberregionalText ? <p className="teaser-text mt-3">{vm.ueberregionalText}</p> : null}
        </section>
        ...
        <section className="mb-5" id="grundstueckspreise-preisentwicklung">
          <h3 className="h5 text-muted mb-1">Kaufpreis-Entwicklung fuer Grundstuecke</h3>
          {vm.preisentwicklungText ? <p className="mb-3">{vm.preisentwicklungText}</p> : null}
