-- partner_property_offer_i18n (Partner-Immobilien-Uebersetzungen je Angebot/Sprache)

create table if not exists public.partner_property_offer_i18n (
...
drop policy if exists "partner_property_offer_i18n_self_select" on public.partner_property_offer_i18n;
create policy "partner_property_offer_i18n_self_select"
  on public.partner_property_offer_i18n
  for select
  using (auth.uid() = partner_id);

drop policy if exists "partner_property_offer_i18n_self_insert" on public.partner_property_offer_i18n;
create policy "partner_property_offer_i18n_self_insert"
  on public.partner_property_offer_i18n
  for insert
  with check (auth.uid() = partner_id);

drop policy if exists "partner_property_offer_i18n_self_update" on public.partner_property_offer_i18n;
create policy "partner_property_offer_i18n_self_update"
  on public.partner_property_offer_i18n
  for update
  using (auth.uid() = partner_id)
  with check (auth.uid() = partner_id);

drop policy if exists "partner_property_offer_i18n_self_delete" on public.partner_property_offer_i18n;
create policy "partner_property_offer_i18n_self_delete"
  on public.partner_property_offer_i18n
  for delete
  using (auth.uid() = partner_id);
